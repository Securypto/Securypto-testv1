...
In order to support loading of multiple wallets in securypto-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is securypto.cpp.
...
Changes to securypto.cpp
----------------------
securypto.cpp is the entry point into securypto-qt, and as such, will require some minor modifications to provide hooks for
