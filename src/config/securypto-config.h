/* src/config/securypto-config.h.  Generated from securypto-config.h.in by configure.  */
/* src/config/securypto-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.securypto.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Securypto Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Securypto Core 1.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "securypto"
