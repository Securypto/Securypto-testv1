...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/securypto-cli.cpp \
           src/securypto-tx.cpp \
           src/securypto.cpp \
           src/db.cpp \
           ...
           src/qt/securypto.cpp \
           src/qt/securyptostrings.cpp \
...
RESOURCES += src/qt/securypto.qrc src/qt/securypto_locale.qrc

TRANSLATIONS += src/qt/locale/securypto_bg.ts \
                src/qt/locale/securypto_de.ts \
                src/qt/locale/securypto_en.ts \
                src/qt/locale/securypto_es.ts \
                src/qt/locale/securypto_fi.ts \
                src/qt/locale/securypto_fr.ts \
                src/qt/locale/securypto_it.ts \
                src/qt/locale/securypto_ja.ts \
                src/qt/locale/securypto_pl.ts \
                src/qt/locale/securypto_pt.ts \
                src/qt/locale/securypto_ru.ts \
                src/qt/locale/securypto_sk.ts \
                src/qt/locale/securypto_sv.ts \
                src/qt/locale/securypto_vi.ts \
                src/qt/locale/securypto_zh_CN.ts \
                src/qt/locale/securypto_zh_TW.ts
